...
namespace TransferLearningTF
{
    ...
    class ProgrammeMachineLearning
    {
        ...
        static void Main(string[] args)
        {
            ...
            ITransformer model = GenerateModel(mlContext, "tags.tsv", "test-tags.tsv");
        ...
        public static ITransformer GenerateModel(MLContext mlContext,string tag, string tagTest)
        {
            string _trainTagsTsv = Path.Combine(_imagesFolder, tag);
            string _testTagsTsv = Path.Combine(_imagesFolder, tagTest);
