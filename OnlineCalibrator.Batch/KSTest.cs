...
namespace OnlineCalibrator.Batch
{
    ...
    /// 
    [Serializable]
    public class KSTest : HypothesisTest<KSDistribution>,
        IHypothesisTest<KSDistribution>
    {
        ...
        /// 
        public KSTest(double[] sample, IDistribution<double> hypothesizedDistribution)
            ...
            KolmogorovSmirnovTestHypothesis alternate = KolmogorovSmirnovTestHypothesis.SampleIsDifferent)
        {
            ...
            StatisticDistribution = new KSDistribution(sample.Length);
        ...
        {
            if (Tail == Accord.Statistics.Testing.DistributionTail.TwoTail)
